...
Description: Module with spider for downloading land books from Archives.
...
from ArchiveScraper.spiders.batch_downloaders.archives_urbariums import parse_and_set_locations
import asyncio


class ArchivesLandBooksScraper(CrawlSpider):
    name = constants.sn_archives_land_books
    archive = constants.a_archives
    start_urls = ["https://digi.archives.cz/da/searchlink?myQuery=6281bccc06a1a58c06cc81dcc4d930b9&modeView=LIST"]
    ...
    def parse_item(self, response):
        ...
        # Write specific type
        auxiliary.add_to_item_if_not_none(response, archive_item,
                                          'specificType', "//div[contains(@class, 'typKnihy')]/text()")
